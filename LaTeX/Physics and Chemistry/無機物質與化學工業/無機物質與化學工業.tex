...
& 3.04 & 71 & 氣態 & 146 (-3), 27 (+5) & -3, +2, +3, +4, +5 & 0.09 (N$_2\to$NH$_3$), 1.25 (NO$_3^{\phantom{3}-}\to$N$_2$), 0.94 (NO$_3^{\phantom{3}-}\to$HNO$_2$), 0.96 (NO$_3^{\phantom{3}-}\to$NO), 1.03 (NO$_2\to$NO), 0.99 (HNO$_2\to$NO) & -\\\hline
...
& 2.58 & 105 & 正交 & 184 (-2), 37 (+4), 29 (+6) & -2, +2, +4, +6 & 0.14 (S$\to$H$_2$S), 0.50 (SO$_2\to$S), -0.25 (HSO$_4^{\phantom{4}-}\to$S$_2$O$_6^{\phantom{6}2-}$), 0.57 (S$_2$O$_6^{\phantom{6}2-}\to$H$_2$SO$_3$), 0.16 (HSO$_4^{\phantom{4}-}\to$SO$_2$), 0.40 (SO$_2\to$S$_2$O$_3^{\phantom{3}2-}$), 0.51 (SO$_2\to$S$_4$O$_6^{\phantom{6}2-}$), 0.17 (SO$_4^{\phantom{4}2-}\to$SO$_2$) & 藍\\\hline
...
\ssc{氧化還原力表}
\sssc{氧化力表}
氧化力 (還原產物, 標準還原電位 (V))：\ce{F2} (\ce{F-}, 2.87) > \ce{Co^{3+}} (\ce{Co^{2+}}, 1.92) > 酸中 \ce{H2O2} (\ce{H2O}, 1.78) > > \ce{Pb^{4+}} (\ce{Pb^{2+}}, 1.69) > \ce{Ce^{4+}} (\ce{Ce^{3+}}, 1.61) > 酸中 \ce{MnO4-} (\ce{Mn^{2+}}, 1.52) > \ce{Cl2} (\ce{Cl-}, 1.36) > 酸中 \ce{Cr2O7^{2-}} (\ce{Cr^{3+}}, 1.33) > 酸中 \ce{MnO2} (\ce{Mn^{2+}}, 1.21) > \ce{Br2} (\ce{Br-}, 1.07) > \ce{VO2^{2+}} (\ce{VO^{2+}}, 1.00) > 酸中 \ce{HNO2} (\ce{NO}, 0.99)  > \ce{NO3-} (\ce{NO}, 0.96) > \ce{Hg^{2+}} (\ce{Hg}, 0.85) > \ce{Hg2^{2+}} (\ce{Hg}, 0.80) > \ce{Ag+} (\ce{Ag}, 0.80) > \ce{Fe^{3+}} (\ce{Fe^{2+}}, 0.77) > 弱鹼中 \ce{MnO4-} (\ce{MnO2}, 0.59) > \ce{I2} (\ce{I-}, 0.53) > \ce{Mn^{3+}} (\ce{Mn^{2+}}, 0.34) = \ce{VO^{2+}} (\ce{V^{3+}}, 0.34) > \ce{Cu^{2+}} (\ce{Cu+}, 0.16) > \ce{Sn^{4+}} (\ce{Sn^{2+}}, 0.15)

簡表（氧化力大到小）：氟 > 鈷(III) > 酸過氧化氫 > 鉛(IV) > 鈰(IV) > 酸過錳酸根 > 氯 > 酸二鉻酸根 > 酸二氧化錳 > 溴 > 酸亞硝酸根 > 硝酸根  > 鐵(III) > 鹼過錳酸根 > 碘 > 錳(III)> 銅(II) > 錫(IV)
\sssc{還原力表}
還原力 (氧化產物, 標準氧化電位 (V))：Li (\ce{Li+}, 3.05) > Rb (\ce{Rb+}, 2.98) > K (\ce{K+}, 2.93) > Cs (\ce{Cs+}, 2.92) > Ba (\ce{Ba^{2+}}, 2.90) > Sr (\ce{Sr^{2+}}, 2.89) > Ca (\ce{Ca^{2+}}, 2.87) > Ra (\ce{Ra^{2+}}, 2.8) > Na (\ce{Na+}, 2.71) > Mg (\ce{Mg^{2+}}, 2.36) > Ce (\ce{Ce^{3+}}, 2.34) > Sc (\ce{Sc^{3+}}, 2.09) > Be (\ce{Be^{2+}}, 1.97) > Al (\ce{Al^{3+}}, 1.66) > Ti (\ce{Ti^{3+}}, 1.37) > V (\ce{V^{2+}}, 1.13) > Mn (\ce{Mn^{2+}}, 1.17) > Si (\ce{SiO2}, 0.91) > B (\ce{H3BO3}, 0.89) > Zn (\ce{Zn^{2+}}, 0.76) > Cr (\ce{Cr^{3+}}, 0.74) > Ga (\ce{Ga^{3+}}, 0.55) > S (\ce{SO2}, 0.50) > Fe (\ce{Fe^{2+}}, 0.44) > Cd (\ce{Cd^{2+}}, 0.4) > Tl (\ce{Tl+}, 0.34) > Co (\ce{Co^{2+}}, 0.28) > Ni (\ce{Ni^{2+}}, 0.23) > Sn (\ce{Sn^{2+}}, 0.14) > In (\ce{In+}, 0.13) > Pb (\ce{Pb^{2+}}, 0.13) > C (\ce{CO2}, 0.11) > H$_2$ (\ce{H2O}, 0.0000) > \ce{Cu+} (\ce{Cu^{2+}}, -0.16) > Cu (\ce{Cu^{2+}}, -0.18) > \ce{I-} (\ce{I2}, -0.53) > \ce{Fe^{2+}} (-0.77) > Hg (\ce{Hg2^{2+}}, -0.80) > Ag (\ce{Ag+}, -0.80) > Pd (\ce{Pd^{2+}}, -0.92) > \ce{Br-} (\ce{Br2}, -1.07) > Pt (\ce{Pt^{2+}}, -1.19) > \ce{Cl-} (\ce{Cl2}, -1.36) > Au (\ce{Au^{3+}}, -1.42) > \ce{Ce^{3+}} (\ce{Ce^{4+}}, -1.61) > \ce{Co^{2+}} (\ce{Co^{3+}}, -1.92) > \ce{F-} (\ce{F2}, -2.87)
...
\begin{itemize}
\item 銀白：\ce{Li}, \ce{Na}, \ce{K}, \ce{Rb}, \ce{Mg}, \ce{Sr}, \ce{Ba}, \ce{Al}, \ce{Sn}, \ce{Sc}, \ce{Ti}, \ce{Ni}, \ce{Pd}, \ce{Ag}, \ce{Cd}, \ce{Ce}, \ce{Pt}, \ce{Hg}.
...
\item 黃：鉻酸鹽, 碘化物, \ce{CdS}, \ce{As2S3}, \ce{Bi2S3}, \ce{Mg3N2}, 含\ce{[Fe(CN)6]^{4-}}者, \ce{HgSO4$\cdot$HgO}, \ce{Hg2F2}, \ce{FeOOH$\cdot$H2O}, \ce{Cr(OH)2}, \ce{K2O2}, \ce{KO2}.
\item 綠：\ce{[Cr(H2O)3(OH)3]}, \ce{[Cr(H2O)3Cl3]}, \ce{Cr2O3}, 反式\ce{[Cr(NH3)3Cl3]}, 反式\ce{[Cr(NH3)4Cl2]Cl}, 反式\ce{[Co(NH3)3Cl3]}, 反式\ce{[Co(NH3)4Cl2]Cl}, \ce{NiO}, \ce{Fe(SCN)2}, \ce{(NH4)2Fe(SO4)2$\cdot 6$H2O}, \ce{[Fe(H2O)4(OH)2]}, 含\ce{[Fe(NH3)6]^{2+}}者.
\item 翠綠：\ce{Cu2(OH)2CO3}, \ce{K3[Fe(C2O4)3]$\cdot 3$H2O}.
\item 藍綠：\ce{CuCO3}, \ce{[Co(H2O)4(OH)2]}, \ce{FeSO4$\cdot 7$H2O}.
\item 墨綠：錳酸鹽.
...
\item 磚紅：\ce{Ag2CrO4}, \ce{[Cr2(CH3COO)4(H2O)2]}.
\item 紅棕：\ce{Ca3N2}, \ce{Fe2O3}, \ce{FeOOH}, 無定形\ce{FeOOH$\cdot x$H2O}, \ce{Fe2(CO3)3}, \ce{Cu2[Fe(CN)6]$\cdot 7$H2O}.
\item 紅：\ce{Sb2S3}, \ce{Cu}, 含\ce{Cu^+}者, 含\ce{[Fe(CN)6]^{3-}}者.
\item 血紅：\ce{Fe(SCN)3}.
\item 粉紅：\ce{[Co(H2O)4Cl2]$\cdot 2$H2O}, \ce{[Co(H2O)4(OH)2]}, \ce{CoCO3}, 含\ce{Mn^{2+}}者.
\item 紫紅：\ce{Li3N}, \ce{[Co(H2O)2Cl2]}, \ce{[Cr(NH3)5Cl]Cl2}, \ce{[Co(NH3)5Cl]Cl2}, \ce{I2}與分支澱粉錯合物.
\item 淡紫：\ce{KFe(SO4)2$\cdot 12$H2O}.
\item 紫：\ce{CrO3}, \ce{[Cr(H2O)6]Cl3}, 順式\ce{[Cr(NH3)3Cl3]}, 順式\ce{[Cr(NH3)4Cl2]Cl}, 順式\ce{[Co(NH3)3Cl3]}, 順式\ce{[Co(NH3)4Cl2]Cl}.
\item 深紫：過錳酸鹽, \ce{KCr(SO4)2$\cdot 12$H2O}.
\item 藍紫：\ce{CoCl2$\cdot$H2O}.
\item 深藍：\ce{Fe4[Fe(CN)6]3}, \ce{VO2}.
\item 藍：無水\ce{CoCl2}, 含\ce{VO^{2+}}者, 含\ce{Cu^{2+}}者, \ce{I2}與直鏈澱粉錯合物.
\item 灰白：炔銀.
\item 灰綠：\ce{CoO}.
...
\item 黃：鉻酸鹽, 碘化物, \ce{CdS}, \ce{Mg3N2}, 含\ce{[Fe(CN)6]^{4-}}者, \ce{Hg2F2}, \ce{K2O2}, \ce{KO2}.
\item 綠：\ce{[Cr(H2O)3(OH)3]}, \ce{[Cr(H2O)3Cl3]}, \ce{Cr2O3}, \ce{(NH4)2Fe(SO4)2$\cdot 6$H2O}, \ce{[Fe(H2O)4(OH)2]}.
\item 翠綠：\ce{Cu2(OH)2CO3}, \ce{K3[Fe(C2O4)3]$\cdot 3$H2O}.
\item 藍綠：\ce{CuCO3}, \ce{[Co(H2O)4(OH)2]}.
\item 墨綠：錳酸鹽.
\item 橙紅：\ce{Pb3O4}, \ce{HgO}, \ce{HgI2}, 含\ce{Cr2O7^{2-}}者.
\item 磚紅：\ce{Ag2CrO4}.
\item 紅棕：\ce{Fe2O3}, \ce{FeOOH}, 無定形\ce{FeOOH$\cdot x$H2O}, \ce{Fe2(CO3)3}, \ce{Cu2[Fe(CN)6]$\cdot 7$H2O}.
\item 紅：\ce{Cu}, 含\ce{Cu^+}者, 含\ce{[Fe(CN)6]^{3-}}者.
\item 血紅：\ce{Fe(SCN)3}.
\item 粉紅：\ce{[Co(H2O)4Cl2]$\cdot 2$H2O}, \ce{[Co(H2O)4(OH)2]}, 含\ce{Mn^{2+}}者.
\item 紫紅：\ce{Li3N}, \ce{[Co(H2O)2Cl2]}, \ce{I2}與分支澱粉錯合物.
\item 紫：\ce{[Cr(H2O)6]Cl3}.
\item 深紫：過錳酸鹽.
\item 藍紫：\ce{CoCl2$\cdot$H2O}.
\item 深藍：\ce{Fe4[Fe(CN)6]3}.
\item 藍：無水\ce{CoCl2}, 含\ce{Cu^{2+}}者, \ce{I2}與直鏈澱粉錯合物.
\item 灰白：炔銀.
...
\item 淡黃色、劇毒氣體。常見氧化劑中最強者，但弱於惰性氣體氟化物。電解\ce{F^-(aq)}陽極產物為\ce{O2}而非\ce{F2}。
\item 與水發生強烈氧化還原反應：
...
\sssc{氯化鉻(III)}
無水氯化鉻(III)為深綠色固體；六水合氯化鉻(III)為紫色固體；溶於水，溶液紫色。
\sssc{乙酸鉻(II)}
...
\item \tb{無定形水合氫氧氧化鐵(III)}\ce{FeOOH$\cdot x$H2O}/\ce{Fe2O3$\cdot (2x+1)$H2O}：鐵(III)離子溶液遇鹼沉澱出紅棕色膠狀固體為之。
\item \tb{褐鐵礦（Limonite）}：褐鐵礦泛指以之為成分的礦物，通常是黃至棕色無定形固體。
\item 無定形一水合氫氧氧化鐵(III)\ce{FeOOH$\cdot$H2O}/氫氧化鐵(III)\ce{Fe(OH)3}/三水合氧化鐵(III)\ce{Fe2O3$\cdot 3$H2O}：黃色固體，為黃色顏料 Pigment Yellow 42。
\item 氫氧氧化鐵(III)、其水合物與三氧化二鐵(III)加熱後均脫水成三氧化二鐵(III)：
...
\item \tb{六水鐵(III)離子}\ce{[Fe(H2O)6]^{3+}}：黃或褐色。
...
銀灰色固體，具鐵磁性，常用於製造磁鐵。
\sssc{一氧化鈷}
灰綠色固體。與氧化鋁於約1200°C燒結均可得鈷藍（Cobalt blue）\ce{CoO$\cdot$Al2O3}，常用於陶瓷藍色釉料。
\sssc{四氧化三鈷}
黑色固體。
\sssc{氯化亞鈷}
...
由於氧化鋁熔點2072°C，故添加冰晶石（Cryolite）\ce{Na3[AlF6]}（有時與氟化鋁）作為助熔劑，使熔點降至約900–1000°C。以正/陽極為碳棒，電解槽以不鏽鋼槽加石墨內襯，電解熔融態氧化鋁：
\begin{itemize}
\item 負/陰極半反應：\ce{Al^{3+}(l) + 3e^- -> Al(l)}，液態鋁密度較\ce{Al2O3(l)}與\ce{Na3[AlF6](l)}大而在下。
...
\bit
\item 多侖試劑\ce{[Ag(NH3)2]NO3(aq)}中滴加強還原劑發生銀鏡反應。
...
\ssc{釹磁鐵（Neodymium magnet）/釹鐵硼磁鐵（NdFeB magnet）}
