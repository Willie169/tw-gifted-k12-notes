...
\item -2: 氧離子\ce{O^{2-}}, 過氧根離子\ce{O2^{2-}}, \ce{S^{2-}}, \ce{Se^{2-}}, 亞磷酸根離子\ce{HPO3^{2-}}, 磷酸氫根離子\ce{HPO4^{2-}}, 錳酸根離子\ce{MnO4^{2-}}, 亞硫酸根離子\ce{SO3^{2-}}, \ce{SO4^{2-}}, 過一硫酸根離子\ce{SO5^{2-}}, 硫代硫酸根離子\ce{S2O3^{2-}}, 連二亞硫酸根離子\ce{S2O4^{2-}}, 焦亞硫酸根/偏二亞硫酸根離子\ce{O3S2O2^{2-}}, 連二硫酸根離子\ce{O3S2O3^{2-}}, 焦硫酸根/連二硫酸根離子\ce{O3SOSO3^{2-}}, 過二硫酸根離子\ce{O3SOOSO3^{2-}}, 連$x$硫酸根離子/$x$硫磺酸根離子\ce{O3SS$_{x-2}$SO3^{2-}}, 鉻酸根離子\ce{CrO4^{2-}}, 二鉻酸根離子\ce{Cr2O7^{2-}}, 碳酸根離子\ce{CO3^{2-}}, $x$烷二酸根離子\ce{(CH2)$_{x-2}$C2O4^{2-}}, 氰胺離子\ce{CN2^{2-}}, 硼酸氫根離子\ce{HBO3^{2-}}, 砷酸氫根離子\ce{HAsO4^{2-}}.
...
\item \ce{[Cr(OH)6]^{3-}}: 綠. 
\item 多數\ce{Cr^{3+}}與酸根離子或鹵素離子（與水）形成的六配位數錯離子: 綠.
\item \ce{CrO4^{2-}}: 黃.
\item \ce{Cr2O7^{2-}}: 橙.
\item \ce{CrO3Cl^-}：橙.
\item \ce{Mn^{2+}}: 粉紅.
...
\item 白：氟化物, 氯化物, 硫酸鹽, 亞硫酸鹽, 焦亞硫酸鹽, 硫代硫酸鹽, 碳酸鹽, 羧酸鹽, 草酸鹽, 氫氧化物, 含\ce{Zn^{2+}}者, 無水\ce{CuSO4}, \ce{PbSO4}, \ce{TiO2}, \ce{HgBr2}, \ce{CaC2}.
\item 白至灰綠：\ce{CrCl2}.
\item 白或黃：\ce{FeCO3}.
...
\item 黃：鉻酸鹽, 碘化物, \ce{CdS}, \ce{As2S3}, \ce{Bi2S3}, 含\ce{Pb^{2+}}者, \ce{Mg3N2}, 含\ce{[Fe(CN6)]^{4-}}者, \ce{HgSO4$\cdot$HgO}, \ce{Hg2F2}, 含\ce{[Co(NH3)6]^{2+}}者, \ce{FeOOH$\cdot$H2O}, \ce{Cr(OH)2}.
\item 金：\ce{Au}.
...
\item \tb{過氧化物（Peroxide）}：具有O$^-$-O$^-$ 的離子化合物或 R-O-O-R'，氧的氧化數為 -1，如\ce{Na2O2}。
\item \tb{超氧化物（Superoxide）}：具有 O$^-$-O$\cdot$（共振）的離子化合物，氧的氧化數為 -0.5，如\ce{NaO2}。
...
\subsubsection{元素態鉀}
\begin{itemize}
\item 鉀元素在自然界中不以元素態存在，而以化合物存在於海水及地殼，占海洋約 0.038\%，占地殼約 2.33\%，主要礦物如光鹵石\ce{KMgCl3$\cdot$6H2O}。
\item 銀白色有光澤柔軟金屬。
...
\subsubsection{元素態鋁}
\begin{itemize}
\item 鋁在自然界中不以元素態存在，而以化合物存在，占地殼約 8.23\%，為地殼含量最高之金屬與第三高的元素，主要存在於\tb{鋁土礦/（鋁）礬土（Bauxite）}\ce{Al2O3$\cdot x$H2O}中。
...
\eit
\sssc{鉻(III)離子與氫氧化鉻(III)}
\bit
\item \tb{六水鉻(III)離子}\ce{[Cr(H2O)6]^{3+}}：紫色正八面體錯離子，中性鉻(III)水溶液主要形式，安定，常簡記作\ce{Cr^{3+}}。
\item 鉻(III)離子在酸中易與酸根離子或鹵素離子（與水）形成綠色六配位數可溶性錯離子，常簡記作\ce{Cr^{3+}}。
...
\item \tb{二鉻酸根離子}\ce{Cr2O7^{2-}}：結構 O=Cr(=O)(-O$^-$)-O-Cr(=O)(-O$^-$)=O，橙色，酸中安定，強氧化力。因與鉻酸鉀之可逆反應，氧化力與質子濃度正相關，\ce{K2Cr2O7(aq)}為實驗室常用強氧化劑，可氧化甲醇、一級醇、二級醇、草酸根、亞鐵離子、錫(II)離子等。
\item \tb{二鉻酸鉀}\ce{K2Cr2O7}：橙色固體。
\item 鉻酸根與二鉻酸根的可逆反應：
\[\ce{2CrO4^{2-}(aq) + 2H^+(aq) <=>[\text{酸}][\text{鹼}] Cr2O7^{2-}(aq) + H2O(l)}\]
\item 酸中二鉻酸根氧化雙氧水生成鉻(III)離子與酸根離子或鹵素離子（與水）形成的綠色六配位數可溶性錯離子（常簡記作\ce{Cr^{3+}}，下簡記之）與氧氣：
...
\bit
\item 主要以硫化礦存在，如\tb{硃砂/丹砂/辰砂（Cinnabar）}\ce{HgS}與\tb{黑辰砂（Metacinnabar）}\ce{HgS}。
