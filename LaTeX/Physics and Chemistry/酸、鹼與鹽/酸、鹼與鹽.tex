...
\item 阿瑞尼斯酸鹼中和為淨離子反應式為\ce{H+(aq) + OH-(aq) -> H2O(l)}的反應。
\eit
\sssc{阿瑞尼斯酸鹼的分類}
\begin{itemize}
...
單元酸\ce{HA$^{n+}$}（通常$n=0$或$1$）的酸解離常數$K_a$為：
\[K_a=\frac{[\ce{H+}][\ce{A$^{(n-1)+}$}]}{[\ce{HA$^{n+}$}]}\]

$m$元酸\ce{H$_m$A$^{n+}$}（通常$n=0$）的第$i$酸解離常數$K_{ai}$為：
\[K_{ai}=\frac{[\ce{H+}][\ce{H$_{m-i}$A$^{(n-i)+}$}]}{[\ce{H$_{m-i+1}$A$^{(n-i+1)+}$}]}\]
\subsubsection{鹼解離常數（Base dissociation constant）}
單元鹼\ce{B$^{n-}$}（通常$n=0$或$1$）的鹼解離常數$K_b$為：
\[K_b=\frac{[\ce{HB$^{(n-1)-}$}][\ce{OH-}]}{[\ce{B$^{n-}$}]}\]

單元鹼\ce{BOH$^{n-}$}（通常$n=0$）的鹼解離常數$K_b$為：
\[K_b=\frac{[\ce{B$^{(n-1)-}$}][\ce{OH-}]}{[\ce{BOH$^{n-}$}]}\]

$m$元鹼\ce{B$^{n-}$}（通常$n=m$）的第$i$鹼解離常數$K_{bi}$為：
\[K_{bi}=\frac{[\ce{H$_i$B$^{(n-i)-}$}][\ce{OH-}]}{[\ce{B$^{(n-i+1)-}$}]}\]

$m$元鹼\ce{B(OH)$_m^{\phantom{m}n-}$}（通常$n=0$）的第$i$鹼解離常數$K_{bi}$為：
...
水的離子積定義為：
\[K_w = [\ce{H+}][\ce{OH-}]\]
水的離子積等於水的解離常數乘以其莫耳濃度（假設溶質可忽略、密度恆為 1000 kg/m$^3$，則為 55.$\bar{5}$ M）。因反應熱 +57.27 kJ，故離子積略正比於絕對溫度的對數，0°C 時 \( K_w = 1.3 \times 10^{-15} \)、25°C 時 \( K_w = 1 \times 10^{-14} \)、60°C 時 \( K_w = 1 \times 10^{-13} \)。25°C 時，水的解離常數為 \scinote{1.8}{-16} M、解離度為 \scinote{1.8}{-9}。
...
\item 強酸：每莫耳解離質子莫耳數大於等於一之物質。穩定者包含 \ce{HClO4}, \ce{HI}, \ce{HBr}, \ce{HCl}, \ce{H2SO4}, \ce{HClO3}, \ce{HNO3}。常近似為[\ce{H+}]=[\ce{HA-}]。
\item 強鹼：每莫耳解離氫氧根離子莫耳數大於等於一之物質。穩定者包含除了鋰外的鹼金屬的氫氧化物、\ce{Ca(OH)2}、\ce{Sr(OH)2}、\ce{Ba(OH)2}。常近似為[\ce{OH-}]=$n$[\ce{B^{n+}}]。
...
指可作為布—洛酸亦可作為布—洛鹼之物質。如：\ce{H2O}, \ce{Be(OH)2}, \ce{Al2O3}, \ce{Al(OH)3}, \ce{Ga2O3}, \ce{Ga(OH)3}, \ce{SnO}, \ce{Sn(OH)2}, \ce{PbO}, \ce{Pb(OH)2}, \ce{Cr(H2O)3(OH)3}, \ce{Cr2O3}, \ce{ZnO}, \ce{Zn(OH)2}, \ce{H2O}, \ce{HSO4-}, \ce{HS2O3-}, \ce{HSO3-}, \ce{HCO3-}, \ce{HS-}, \ce{H2PO3-}, \ce{H2PO4^{2-}}, \ce{H3PO4-}, \ce{HC2O4-}, \ce{H2AsO4-}, \ce{HAsO4^{2-}}, \ce{C6H4(COOH)(COO-)}, 胺基酸。
